...
const fuse = new Fuse(
  [
    ...
    'client.webhookConfigs.listPaginated',
    ...
    'client.beta.sheets.create',
    'client.beta.sheets.deleteJob',
    'client.beta.sheets.get',
    'client.beta.sheets.getResultTable',
